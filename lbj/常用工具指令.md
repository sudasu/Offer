...
gg	\\跳转至头部
```
select cdn,log_type,log_time,sum(sendsize) as sendsize from cdn_live_2021 where cdn = "金山p2p-p2p" and country = "all" and log_type = "min" and log_time like '2021-06%' group by log_time
#git指令
##常用基础
